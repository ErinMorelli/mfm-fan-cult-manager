...
from mfm_fan_cult.content_types import *  # pylint: disable=W0401,W0614


class FanCultManager:
    """Core utilities and setup actions."""
    user_path = os.path.expanduser('~')
    # Manager configuration files storage location
    config_env_var = 'MFM_FCM_CONFIG_PATH'
    config_default = os.path.join(user_path, '.config', 'mfm-fan-cult')
    ...
    def __init__(self):
        ...
        self._types = self.inheritors(FanCultContent)
